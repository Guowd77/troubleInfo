...
var x5=_mz(z,'view',['catchtouchmove',2,'class',1,'data-event-opts',2],[],e,s,gg)
var o6=_v()
_(x5,o6)
...
var f7=_mz(z,'uni-calendar',['bind:__l',6,'bind:confirm',1,'class',2,'data-event-opts',3,'data-ref',4,'insert',5,'vueId',6],[],e,s,gg)
_(b3,f7)
o4.wxXCkey=1
_(r,b3)
return r
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/login"],{"190f":function(t,o,n){"use strict";(function(t){Object.defineProperty(o,"__esModule",{value:!0}),o.default=void 0;n("2f62");var e=n("3b07"),a={data:function(){return{title:"",account:"",password:"",oldAccount:"",oldPassword:""}},onLoad:function(){try{var o=t.getStorageSync("account"),n=t.getStorageSync("password"),a=t.getStorageSync("logout");if(this.account=o,this.password=n,!a&&n){var c={username:o,password:n};(0,e.userlogin)(c).then(function(o){console.log(o.data," at pages\\login.vue:54");try{t.setStorageSync("logout",0)}catch(n){}0==o.data.status&&(t.showToast({title:"登录成功",icon:"none"}),t.redirectTo({url:"index?code="+o.data.org_code+"&name="+o.data.userkey}))})}}catch(s){}},methods:{bindLogin:function(){var o={username:this.account,password:this.password};if(console.log(o," at pages\\login.vue:85"),0!=this.account.length)if(0!=this.password.length){var n=this;(0,e.userlogin)(o).then(function(o){if(console.log(o.data," at pages\\login.vue:102"),0==o.data.status){try{t.setStorageSync("account",n.account),t.setStorageSync("password",n.password),t.setStorageSync("logout",0)}catch(e){}t.redirectTo({url:"index?code="+o.data.org_code+"&name="+o.data.userkey})}})}else t.showToast({title:"请输入密码",icon:"none"});else t.showToast({title:"请输入账号",icon:"none"})}}};o.default=a}).call(this,n("6e42")["default"])},2310:function(t,o,n){"use strict";n.r(o);var e=n("190f"),a=n.n(e);for(var c in e)"default"!==c&&function(t){n.d(o,t,function(){return e[t]})}(c);o["default"]=a.a},"5a90":function(t,o,n){"use strict";var e=n("6c74"),a=n.n(e);a.a},"6c74":function(t,o,n){},bc08:function(t,o,n){"use strict";n.r(o);var e=n("e8f7"),a=n("2310");for(var c in a)"default"!==c&&function(t){n.d(o,t,function(){return a[t]})}(c);n("5a90");var s=n("2877"),r=Object(s["a"])(a["default"],e["a"],e["b"],!1,null,null,null);o["default"]=r.exports},e8f7:function(t,o,n){"use strict";var e=function(){var t=this,o=t.$createElement;t._self._c},a=[];n.d(o,"a",function(){return e}),n.d(o,"b",function(){return a})}},[["e2c8","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index"],{"171e":function(t,e,s){"use strict";s.r(e);var i=s("83e3"),a=s.n(i);for(var n in i)"default"!==n&&function(t){s.d(e,t,function(){return i[t]})}(n);e["default"]=a.a},"7b8e":function(t,e,s){},"83e3":function(t,e,s){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i=s("3b07"),a=s("13c7"),n=function(){return Promise.all([s.e("common/vendor"),s.e("components/uni-calendar/uni-calendar")]).then(s.bind(null,"d1b4"))},l={components:{uniCalendar:n},data:function(){return{modalNumber:0,username:"",modalStyle:{},focusDate:"",code:"",list:"",modalName:null,modalShow:0,seaList:"",seaListDepart:"",showList:[],showVideo:0,haveVideo:0,videoUrl:"",page:0,loadText:"",multiArray:[["成都市"],[],[]],multiIndex:[0,0,0],allList:[{name:"成都市",child1:[]}],focusPlace:""}},methods:{logout:function(){try{t.setStorageSync("logout",1)}catch(e){}t.redirectTo({url:"login"})},showModal:function(t){var e=this;this.modalName="Image",this.modalShow=1,this.haveVideo=0,this.modalNumber=t;var s={filename:this.showList[t].filename.substring(0,this.showList[t].filename.length-4)};console.log(s," at pages\\index.vue:168"),(0,i.getVideo)(s).then(function(t){"success"==t.data.msg?"jpg"!=t.data.data.type&&(e.haveVideo=1,e.videoUrl=t.data.data.path):e.haveVideo=0})},switchVideo:function(){1==this.haveVideo?this.showVideo=!this.showVideo:t.showToast({title:"本条无视频",icon:"none",duration:1500})},videoErrorCallback:function(e){t.showModal({content:e.target.errMsg,showCancel:!1})},hideModal:function(){this.modalName=null,this.modalShow=0},open:function(){this.$refs.calendar.open()},chooseFocusPlace:function(t){if(this.focusPlace=this.allList[t.detail.value[0]].child1[t.detail.value[1]].child2[t.detail.value[2]],console.log(this.focusPlace," at pages\\index.vue:208"),this.showList=[],this.page=0,console.log(this.seaList," at pages\\index.vue:211"),this.seaListDepart=this.searchDepart(this.focusPlace),0!=this.seaListDepart.length){for(var e=0+15*this.page,s=e;e<s+15&&e<this.seaListDepart.length;e++)this.showList.push(this.seaListDepart[e]);this.showList.length<this.seaListDepart.length?this.loadText="上拉加载更多":this.showList.length==this.seaListDepart.length&&(this.loadText="加载完毕")}else 0==this.seaListDepart.length&&(this.loadText="本日此加油站没有数据")},confirm:function(t){if(this.page=0,console.log(t.fulldate," at pages\\index.vue:230"),this.focusDate=t.fulldate,this.seaList=[],this.seaList=this.search(t.fulldate),this.seaList=(0,a.sortArray)(this.seaList),this.showList=[],0!=this.seaList.length){for(var e=0;e<this.seaList.length;e++)this.seaList[e].newtime=this.seaList[e].time.substring(11,16);for(var s=0+15*this.page,i=s;s<i+15&&s<this.seaList.length;s++)this.showList.push(this.seaList[s]);this.showList.length<this.seaList.length?this.loadText="上拉加载更多":this.showList.length==this.seaList.length&&(this.loadText="加载完毕")}else 0==this.seaList.length&&(this.loadText="本日没有数据")},search:function(t){var e=[];return this.list.forEach(function(s){-1!=s.time.indexOf(t)&&e.push(s)}),e},searchDepart:function(t){var e=[];return console.log(this.seaList," at pages\\index.vue:265"),this.seaList.forEach(function(s){-1!=s.departname.indexOf(t)&&e.push(s)}),e},bindMultiPickerColumnChange:function(t){switch(this.multiIndex[t.detail.column]=t.detail.value,t.detail.column){case 0:this.multiIndex.splice(1,1,0),this.multiIndex.splice(2,1,0);break;case 1:for(var e=0;e<this.allList[0].child1.length;e++)if(this.multiIndex[1]==e){this.multiArray[2]=this.allList[0].child1[e].child2;break}this.multiIndex.splice(2,1,0);break}this.$forceUpdate()}},onLoad:function(t){this.code=t.code,this.username=t.name;var e=new Date,s=e.getFullYear(),a=(e.getMonth()+1).toString().padStart(2,"0"),n=e.getDate().toString().padStart(2,"0");this.focusDate="".concat(s,"-").concat(a,"-").concat(n);var l={departid:this.code},h=this;(0,i.getDepart)(l).then(function(t){if(3==t.data[0].orgcode.length){for(var e=0;e<t.data.length;e++)if(3==t.data[e].orgcode.length)h.allList[0].child1.push({name:t.data[e].childname,child2:[]}),h.multiArray[1].push(t.data[e].childname);else if(t.data[e].orgcode.length>3)for(var s=0;s<h.allList[0].child1.length;s++)t.data[e].departname==h.allList[0].child1[s].name&&(h.allList[0].child1[s].child2.push(t.data[e].childname),0==s&&h.multiArray[2].push(t.data[e].childname))}else if(6==t.data[0].orgcode.length){h.allList[0].child1.push({name:t.data[0].departname,child2:[]}),h.multiArray[1].push(t.data[0].departname);for(e=0;e<t.data.length;e++)t.data[e].departname==h.allList[0].child1[0].name&&(h.allList[0].child1[0].child2.push(t.data[e].childname),h.multiArray[2].push(t.data[e].childname))}else h.multiArray=[[],["服务器出错"],[]];console.log(h.allList," at pages\\index.vue:348")})},mounted:function(){var e={departid:this.code},s=this;(0,i.getInfo)(e).then(function(e){if(s.list=e.data,s.seaList=s.search(s.focusDate),s.seaList=(0,a.sortArray)(s.seaList),0!=s.seaList.length){for(var i=0,n=i;i<n+15&&i<s.seaList.length;i++)s.seaList[i].newtime=s.seaList[i].time.substring(11,16),s.showList.push(s.seaList[i]);s.showList.length<s.seaList.length?s.loadText="上拉加载更多":s.showList.length==s.seaList.length&&(s.loadText="加载完毕")}0==s.seaList.length&&(s.loadText="本日没有数据"),console.log(s.list," at pages\\index.vue:375"),t.hideLoading()})},onReachBottom:function(){if(this.page=this.page+1,0!=this.seaList.length){for(var e=0+15*this.page,s=e;e<s+15&&e<this.seaList.length;e++)this.showList.push(this.seaList[e]);this.showList.length<this.seaList.length?this.loadText="上拉加载更多":this.showList.length==this.seaList.length&&(this.loadText="--加载完毕--")}else 0==this.seaList.length&&(this.loadText="本日没有数据");t.showLoading({title:"加载中"}),setTimeout(function(){t.hideLoading()},300)}};e.default=l}).call(this,s("6e42")["default"])},"8a5a":function(t,e,s){"use strict";var i=s("7b8e"),a=s.n(i);a.a},bb4f:function(t,e,s){"use strict";s.r(e);var i=s("f10b"),a=s("171e");for(var n in a)"default"!==n&&function(t){s.d(e,t,function(){return a[t]})}(n);s("8a5a");var l=s("2877"),h=Object(l["a"])(a["default"],i["a"],i["b"],!1,null,null,null);e["default"]=h.exports},f10b:function(t,e,s){"use strict";var i=function(){var t=this,e=t.$createElement;t._self._c},a=[];s.d(e,"a",function(){return i}),s.d(e,"b",function(){return a})}},[["33e2","common/runtime","common/vendor"]]]);
});
